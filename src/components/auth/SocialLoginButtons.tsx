...
> = {
  google: {
    ...
    className: "border border-input bg-white hover:bg-gray-50 text-gray-700",
  },
  github: {
    ...
    className: "border border-input bg-[#24292f] hover:bg-[#2d333b] text-white",
  },
  facebook: {
    ...
    className: "border border-input bg-[#1877f2] hover:bg-[#166fe5] text-white",
  },
};
...
export const SocialLoginButtons = () => {
  ...
  const handleOAuthSignIn = async (provider: OAuthProvider) => {
    ...
    try {
      ...
      // User will be redirected to OAuth provider - no need to show success toast
    } catch (error: unknown) {
